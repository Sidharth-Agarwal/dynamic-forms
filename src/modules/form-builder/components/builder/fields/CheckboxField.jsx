...
/**
 * Component for editing checkbox field settings
 * 
  ...
  return (
    <>
      ...
      <div className="form-builder-control">
        ...
        <div className="form-builder-checkbox-preview">
          {options.map((option, index) => (
            <div key={index} className="form-builder-checkbox-item">
              <input
                type="checkbox"
                ...
                onChange={(e) => {
                  let defaultValue = Array.isArray(field.defaultValue) 
                    ? [...field.defaultValue] 
                    : [];
                  ...
                  if (e.target.checked) {
                    ...
                    defaultValue = defaultValue.filter(v => v !== option.value);
                  }
